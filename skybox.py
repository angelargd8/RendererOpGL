...
class Skybox(object):
	...
	def Render(self, viewMatrix, projectionMatrix):
		...
		glUniformMatrix4fv( glGetUniformLocation(self.shaders, "viewMatrix"),  #ubicacion
							1, GL_FALSE, glm.value_ptr( viewMatrix) )#pointer
			
		glUniformMatrix4fv( glGetUniformLocation(self.shaders, "projectionMatrix"), #ubicacion
							1, GL_FALSE, glm.value_ptr( projectionMatrix) )#pointer
		...
		glDrawArrays(GL_TRIANGLES, 0, 36) #36vertices 
